...
| [options] | <code>Graph3DOptions</code> | Passed through to the `Graph3D`   constructor — `canvas` is still required in a browser, since a JSON   snapshot can't carry a DOM element. |
