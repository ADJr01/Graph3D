...
/**
 * The `/api/` sidebar, built from `site/api/manifest.json` — written by
...
const recipesSidebar = [
  ...
  { text: 'Custom HDRI Environment', link: '/recipes/custom-hdri-environment' },
  { text: 'Custom Lighting Setup', link: '/recipes/custom-lighting-setup' },
  { text: 'Cinematic Camera', link: '/recipes/cinematic-camera' },
  ...
  { text: 'graphHTML Custom Labels', link: '/recipes/graphhtml-custom-labels' },
...
const migrationSidebar = [
  ...
  { text: 'From D3', link: '/migration/from-d3' },
  { text: 'From ECharts GL', link: '/migration/from-echarts-gl' },
  { text: 'From raw Three.js', link: '/migration/from-raw-three' },
];
